...
: No, resolve this as per [Transport Vehicles](#transport_vehicles).

Can units that have a special ability that allows them to enter play use it if a aircraft transport them off board?
: No, they may only enter play again via disembarked from the landed aircraft.

Can a transport aircraft jink and still carry out an air assault.
: Yes, so long as it doesn't have a Bomber manoeuvre class.
